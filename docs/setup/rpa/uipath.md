...
## Step 1 — Visit the UiPath Website

Go to [uipath.com](https://www.uipath.com/) to access the UiPath homepage.
...
Enter your **work or personal email address** and click **"Create Account"**.
...
Enter your **Display name** and select your **Country/Region**, then click **"Next"**.
...
Enter any name you like in the **Cloud Organization Name** field, then click **"Create Organization"**.
...
You are now logged in to **UiPath Automation Cloud**. We will explore this platform in detail later in the course — for now, ignore the dashboard.
...
1. Check **Studio** and **Extensions**
2. Leave **Robot** unchecked
